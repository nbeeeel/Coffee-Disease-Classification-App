...
public class MainActivity extends AppCompatActivity {
    ...
    Button camera,gallery,recommendation;
    ImageView imageView;
    TextView result;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        result = findViewById(R.id.textPredict);
    ...
    public void openActivity2(){
        Intent intent = new Intent(this, RecActivity2.class);
    ...
    public void classifyImage(Bitmap image){
        try {
            ...
            String[] classes={"Cerscospora","Healthy","Rust","Miner","Phoma"};
